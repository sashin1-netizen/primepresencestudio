...
export default function AtelierHomePages({ location }: { location: string }) {
  return (
    <main id="main-content" className="overflow-hidden bg-[#040403] text-[#f4efe6]">
      <section className="relative isolate min-h-[calc(100svh-64px)] overflow-hidden border-b border-white/[.07] sm:min-h-[calc(100svh-76px)]">
        ...
        <div className="mx-auto flex min-h-[calc(100svh-64px)] max-w-[1500px] items-end px-5 pb-8 sm:min-h-[calc(100svh-76px)] sm:px-10 sm:pb-12 md:px-12 lg:items-center lg:px-16 lg:pb-14">
          <div className="w-full max-w-[680px]">
            ...
            <div className="mt-6 flex flex-col items-start gap-4 sm:mt-8 sm:flex-row sm:items-center sm:gap-7"><Link href="/contact" className="luxury-cta inline-flex min-h-12 min-w-[190px] items-center justify-between px-5 text-[9px] font-bold uppercase tracking-[.14em] text-[#f2d17c] sm:min-h-14 sm:min-w-56 sm:px-7">Start a Project <span>→</span></Link><Link href="/work" className="inline-flex min-h-10 items-center gap-3 border-b border-white/20 text-[9px] font-bold uppercase tracking-[.14em] text-white/66 transition-colors hover:border-[#d5ad55]/65 hover:text-[#e5bd67]">Explore the Work <span>→</span></Link></div>
      ...
      <section className="relative border-y border-white/[.07] bg-[#070605] px-5 py-20 sm:px-10 sm:py-28 lg:px-16 lg:py-32"><div className="relative mx-auto max-w-[1380px]"><div className="grid gap-6 lg:grid-cols-[.52fr_1.48fr] lg:items-end"><p className="eyebrow">What we create</p><h2 className="premium-title">Three focused offers.<br/><span className="italic text-[#d3a54b]">One uncompromising standard.</span></h2></div><div className="mt-10 divide-y divide-white/[.08] border-y border-white/[.08] sm:mt-14">{offers.map(([number,title,body]) => <Link href="/services" key={number} className="group grid gap-3 py-7 sm:grid-cols-[70px_.8fr_1.2fr_auto] sm:items-center lg:py-10"><p className="text-[10px] font-bold tracking-[.2em] text-[#c99a3c]">{number}</p><h3 className="font-[family-name:var(--font-cormorant)] text-[2.25rem] leading-[.95] text-[#f4eee3] sm:text-[3rem]">{title}</h3><p className="max-w-2xl text-[15px] leading-7 text-white/58 sm:text-base sm:leading-8">{body}</p><span className="text-xl text-[#c99a3c] transition-transform duration-500 group-hover:translate-x-2">→</span></Link>)}</div></div></section>

      <section className="relative px-5 py-20 sm:px-10 sm:py-28 lg:px-16 lg:py-36"><div className="mx-auto grid max-w-[1380px] items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-24"><div><p className="eyebrow">Prime Presence Connect™</p><h2 className="premium-title mt-5">Your presence,<span className="block italic text-[#d8ad55]">carried digitally.</span></h2><p className="mt-6 max-w-2xl text-base leading-8 text-[#c4bbaf] sm:text-lg">A polished digital business card and mini-profile built for introductions, meetings, networking and the moment immediately after.</p><Link href="/connect" className="mt-8 inline-flex min-h-12 items-center gap-5 border-b border-[#c99a3c]/55 text-[10px] font-bold uppercase tracking-[.17em] text-[#e0b75f]">Explore Connect <span>→</span></Link></div><div className="relative mx-auto w-full max-w-[330px] sm:max-w-[390px]"><div className="luxury-device rounded-[40px] p-3"><div className="aspect-[9/16] rounded-[32px] border border-white/[.07] bg-[radial-gradient(circle_at_50%_8%,rgba(201,154,60,.16),transparent_25%),#050504] p-6"><p className="text-center text-[9px] font-bold uppercase tracking-[.22em] text-[#d8ad55]">Prime Presence</p><p className="mt-4 text-center font-[family-name:var(--font-cormorant)] text-4xl">Connect™</p><div className="mx-auto mt-8 h-20 w-20 rounded-full border border-[#c99a3c]/35 bg-[#0b0906]"/><div className="mt-9 space-y-3"><div className="h-12 rounded-xl border border-white/[.08] bg-white/[.02]"/><div className="h-12 rounded-xl border border-white/[.08] bg-white/[.02]"/><div className="h-12 rounded-xl border border-white/[.08] bg-white/[.02]"/></div></div></div></div></div></section>
