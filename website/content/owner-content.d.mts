...
export type SocialLink = { label: string; url: string; confirmed?: boolean };
export type ImageAsset = { src: string; alt: string; width: number; height: number; filename: string };
export type MediaRecord = Approval & { assetId: string; src: string; filename: string; description: string; alt: string; decorative: boolean; routeUsage: string[]; copyrightHolder: string; source: string; licence: string; permissionStatus: "pending" | "approved" | "rejected"; usageRestriction: string; expiry: string | null; bytes?: number };
...
export type OwnerContent = {
  business: { publicName: string; legalName: string; email: string | null; emailConfirmed: boolean; telephone: string | null; telephoneConfirmed: boolean; whatsapp: string | null; whatsappConfirmed: boolean; location: string; serviceArea: string; hours: string; socialLinks: SocialLink[]; copyrightHolder: string; legalContact: string; privacyContact: string; termsContact: string; domain: string; canonicalUrl: string; ownerConfirmed: boolean; approvalDate: string | null };
  ...
  verification: { domainValidated: boolean; realDeviceSignoff: boolean; lighthouseVerified: boolean; productionBuildPassed: boolean; routeChecksPassed: boolean; accessibilityCriticalChecksPassed: boolean; contactFlowPassed: boolean; highSeveritySecurityIssuesResolved: boolean; launchApprovalRecorded: boolean };
};
