...
export const publicStaticPaths = content => ["", "/work", "/services", "/about", "/process", "/contact", "/insights", ...(content.legal.privacyApproval && content.legal.approvalDate ? ["/privacy"] : []), ...(content.legal.termsApproval && content.legal.approvalDate ? ["/terms"] : [])];
